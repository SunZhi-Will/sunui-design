...
const EnhancedFloatingButton = FloatingButton as React.ComponentType<FloatingButtonProps>;
...
export const DraggableWithPersistence: Story = {
    render: () => {
        // Creating a proper React component that can use hooks
        const DraggableWithPersistenceComponent = () => {
        ...
        return <DraggableWithPersistenceComponent />;
    }
};
